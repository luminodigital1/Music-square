...
import '../ApplyForCollab/ApplyForCollab.css';
          ...
          <div className="d-flex justify-content-center align-items-center">
            ...
            <div className="d-flex border border-black rounded offset-md-5
             justify-content-center align-items-center"
              ...
              <Popup trigger={<button className="btn custom-ofr" onClick={closeCO} >Custom offer</button>}
              modal
          ...
          {selectedFiles.map((file, index) => (
            ...
            <div className="d-flex text-center align-items-center ">
              ...
              <div className="d-flex col-md-4 offset-md-8">
                <button className="cancelBtn1" onClick={closeCO}>Cancel</button>
